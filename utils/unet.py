...
Authors: Lee, Cheng-Han and Liu, Ziwei and Wu, Lingyun and Luo, Ping
...
class segnetUp2(nn.Module):
    ...
    def forward(self, inputs, indices, output_shape):
        outputs = self.unpool(input=inputs,
                              indices=indices,
...
class residualBlock(nn.Module):
    ...
    def __init__(self, in_channels, n_filters, stride=1, downsample=None):
        ...
        self.convbnrelu1 = conv2DBatchNormRelu(in_channels,
                                               n_filters,
                                               3,
                                               stride,
                                               1,
                                               bias=False)
        self.convbn2 = conv2DBatchNorm(n_filters,
                                       n_filters,
                                       3,
                                       1,
                                       1,
...
class residualBottleneck(nn.Module):
    ...
    def __init__(self, in_channels, n_filters, stride=1, downsample=None):
        ...
        self.convbn1 = nn.Conv2DBatchNorm(in_channels,
                                          n_filters,
                                          k_size=1,
                                          bias=False)
        self.convbn2 = nn.Conv2DBatchNorm(n_filters,
                                          n_filters,
                                          k_size=3,
                                          padding=1,
                                          stride=stride,
                                          bias=False)
        self.convbn3 = nn.Conv2DBatchNorm(n_filters,
                                          n_filters * 4,
                                          k_size=1,
                                          bias=False)
        self.relu = nn.ReLU(inplace=True)
...
class linknetUp(nn.Module):
    ...
    def __init__(self, in_channels, n_filters):
        ...
        # B, C/2, H, W -> B, C/2, H, W
        self.deconvbnrelu2 = nn.deconv2DBatchNormRelu(n_filters / 2,
                                                      n_filters / 2,
                                                      k_size=3,
                                                      stride=2,
                                                      padding=0)
        ...
        # B, C/2, H, W -> B, C, H, W
        self.convbnrelu3 = conv2DBatchNormRelu(n_filters / 2,
                                               n_filters,
                                               k_size=1,
                                               stride=1,
                                               padding=1)
...
class FRRU(nn.Module):
    ...
    def __init__(self,
        ...
        if self.group_norm:
            ...
            self.conv1 = conv_unit(prev_channels + 32,
                                   out_channels,
                                   k_size=3,
                                   stride=1,
                                   padding=1,
            ...
            self.conv2 = conv_unit(out_channels,
                                   out_channels,
                                   k_size=3,
                                   stride=1,
                                   padding=1,
        ...
        self.conv_res = nn.Conv2d(out_channels,
                                  32,
                                  kernel_size=1,
                                  stride=1,
                                  padding=0)
...
class cascadeFeatureFusion(nn.Module):
    ...
    def forward(self, x_low, x_high):
        x_low_upsampled = F.interpolate(x_low,
                                        size=get_interp_size(x_low,
                                                             z_factor=2),
                                        mode="bilinear",
                                        align_corners=True)
